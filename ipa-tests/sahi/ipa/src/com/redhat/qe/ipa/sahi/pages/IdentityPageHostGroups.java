...
public class IdentityPageHostGroups extends IPAWebPage implements StandardTest {
	...
	private String addPage = "Add Host Group";
	private String duplicatePage = "Add Duplicate Host Group";
	private String modifyPage = "Modify Host Group";
	private String delPage = "Delete Host Group";
	...
	public IdentityPageHostGroups (SahiTasks browser, String testPropertyFile)
	{
		...
		System.out.println("New instance of IdentityPageHostGroups is ready"); 
