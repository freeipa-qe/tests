...
public class IdentityPageUserGroups extends IPAWebPage implements StandardTest {
	...
	private String addPage = "Add User Group";
	private String duplicatePage = "Add Duplicate User Group";
	private String modifyPage = "Modify User Group";
	private String delPage = "Delete User Group"; 
	...
	public IdentityPageUserGroups (SahiTasks browser, String testPropertyFile)
	{
		...
		System.out.println("New instance of IdentityPageUserGroups is ready"); 
