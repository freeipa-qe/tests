...
public class IdentityPageNetgroups extends IPAWebPage implements StandardTest {
	...
	private String addPage = "Add Netgroup";
	private String duplicatePage = "Add Duplicate Netgroup";
	private String modifyPage = "Modify Netgroup";
	private String delPage = "Delete Netgroup";
	...
	public IdentityPageNetgroups (SahiTasks browser, String testPropertyFile)
	{
		...
		System.out.println("New instance of IdentityPageNetgroup is ready"); 
