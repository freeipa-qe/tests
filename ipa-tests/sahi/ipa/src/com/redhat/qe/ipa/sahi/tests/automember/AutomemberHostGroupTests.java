...
public class AutomemberHostGroupTests extends SahiTestScript {

	private static Logger log = Logger.getLogger(GroupTests.class.getName()); 
	private static String [] hostgroups = {"qaservers", "defhostgroup", "bug846754_hstgrp", "a_hstgrp", "b_hstgrp", "bug818258_hstgrp",};
	...
	public void initialize() throws CloneNotSupportedException {	
		...
		for (String hostgroup : hostgroups){
			String groupDescription = hostgroup + " description";
			GroupTasks.addGroup(sahiTasks, hostgroup, groupDescription);
		} 
	...
	public void cleanup() throws Exception {	
		...
		//delete automember hostgroup
    	sahiTasks.navigateTo(commonTasks.hostgroupPage, true);
    	for (String hostgroup : hostgroups) {
    	//Assert.assertTrue(sahiTasks.link(hostgroup).exists(),"before 'Delete', hostgroup exists"); except addthencancel 
    		HostgroupTasks.deleteHostgroup(sahiTasks, hostgroup, "Delete");
    		Assert.assertFalse(sahiTasks.link(hostgroup).exists(),"after 'Delete', hostgroup does NOT exists");
    	}
	...
	public void testAutomemberAddDuplicateMissingSpecifiedName_Bug8182581(String testName,String groupName) throws Exception {
	       	//add and add another automember host group rule and verify the bug
	    	sahiTasks.navigateTo(commonTasks.automemberHostGroupPage, true);
	    	Assert.assertFalse(sahiTasks.link(groupName).exists(),"before 'Add', hostgroup role does NOT exists");
	...
	public void testAutomemberSearchNegativeBug846754(String testName) throws Exception {
	       	sahiTasks.navigateTo(commonTasks.automemberHostGroupPage, true);
	       	String groupNames[] = {"nonexistent", "n", "'<,>.?/", AutomemberHostGroupTests.hostgroups[2] + " ", " " + AutomemberHostGroupTests.hostgroups[2]};
	...
	public void testAutomemberDeleteMultiple(String testName) throws Exception {
	       	sahiTasks.navigateTo(commonTasks.automemberHostGroupPage, true);
	       	String groupNames[]={AutomemberHostGroupTests.hostgroups[0],AutomemberHostGroupTests.hostgroups[1],AutomemberHostGroupTests.hostgroups[2],AutomemberHostGroupTests.hostgroups[3],AutomemberHostGroupTests.hostgroups[5]};
	...
	protected List<List<Object>> createAutomemberAddSingleObjects() {		
        ...
        //									testName		 	   groupName			
		ll.add(Arrays.asList(new Object[]{ "add single",   AutomemberHostGroupTests.hostgroups[0]} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberAddAndAddAnotherObjects() {		
		...
		ll.add(Arrays.asList(new Object[]{ "add and add another",   AutomemberHostGroupTests.hostgroups[1], AutomemberHostGroupTests.hostgroups[2]} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberAddAndEditObjects() {		
        ...
        //									testName		 	                groupName			
		ll.add(Arrays.asList(new Object[]{ "add and edit host group rules",   AutomemberHostGroupTests.hostgroups[3]} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberAddThenCancelObjects() {		
        ...
        //									testName		 	   groupName			
		ll.add(Arrays.asList(new Object[]{ "add then cancel",   AutomemberHostGroupTests.hostgroups[4]} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberAddDuplicateMissingSpecifiedNameBug818258TestObjects() {		
        ...
        //									testName		 	   groupName			
		ll.add(Arrays.asList(new Object[]{ "add duplicate",   AutomemberHostGroupTests.hostgroups[5]} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberConditionAddSingleObjects() {		
		...
		ll.add(Arrays.asList(new Object[]{ "Inclusive",   AutomemberHostGroupTests.hostgroups[0],    "cn",       "cn"} ));
		ll.add(Arrays.asList(new Object[]{ "Exclusive",   AutomemberHostGroupTests.hostgroups[0],    "description",  "description"} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberConditionAddAndAddAnotherObjects() {		
		...
		ll.add(Arrays.asList(new Object[]{ "Inclusive",   AutomemberHostGroupTests.hostgroups[0],    "enrolledby",       "fqdn",      "enrolledby",    "fqdn"}));
		ll.add(Arrays.asList(new Object[]{ "Exclusive",   AutomemberHostGroupTests.hostgroups[0],   "ipaclientversion", "ipakrbauthzdata", "ipaclientversion","ipakrbauthzdata"} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberConditionAddThenCancelObjects() {		
        ...
        //									  testName          groupName                           attribute               expression			
		ll.add(Arrays.asList(new Object[]{ "Inclusive",   AutomemberHostGroupTests.hostgroups[0],  "ipauniqueid",         "ipauniqueid"} ));
		ll.add(Arrays.asList(new Object[]{ "Exclusive",   AutomemberHostGroupTests.hostgroups[0],   "managedby",           "managedby"} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberDefaultGroupObjects() {		
        ...
        //									     testName		 	             groupName			
		ll.add(Arrays.asList(new Object[]{ "modify default host group",   AutomemberHostGroupTests.hostgroups[1]} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberGenericEditObjects() {		
        ...
        //									     testName		 	             groupName			              
		ll.add(Arrays.asList(new Object[]{ "Host group rules",   AutomemberHostGroupTests.hostgroups[2]} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberSearchObjects() {		
        ...
        //									     testName		 	             groupName			              
		ll.add(Arrays.asList(new Object[]{ "search positive",   AutomemberHostGroupTests.hostgroups[3]} ));
		return ll;	
	}
	...
	protected List<List<Object>> createAutomemberDeleteSingleObjects() {		
        ...
        //									     testName		 	             groupName			              
		ll.add(Arrays.asList(new Object[]{ "delete single",   AutomemberHostGroupTests.hostgroups[0]} ));
		return ll;	
	}
