...
selfservice_mod_1002()
{
    rlPhaseStartTest "selfservice_mod_1002 [negative test] --all --attrs;negative;LIST --permissions;positive;LIST --raw"
        ...
        qaRun "ipa selfservice-mod $testID --all  --attrs=$attrs_TestValue_Negative  --permissions=$permissions_TestValue --raw " "$tmpout" $expectedErrCode "$expectedErrMsg" "test options:  (with same attrs) [attrs]=[$attrs_TestValue_Negative] [permissions]=[$permissions_TestValue]" 
        Kcleanup
        rm $tmpout
    rlPhaseEnd
} #selfservice_mod_1002
...
selfservice_mod_1004() # BZ 772675 -- ipa selfservice-mod --raw returns "internal error" message
{
    rlPhaseStartTest "selfservice_mod_1004 [positive test] --all --attrs;positive;LIST --permissions;positive;LIST --raw"
        ...
        rlRun "ipa selfservice-mod $testID --all  --attrs=$attrs_TestValue  --permissions=$permissions_TestValue " 0 "test options:  (change perm, without --raw) [attrs]=[$attrs_TestValue] [permissions]=[$permissions_TestValue]" 
        Kcleanup
        rm $tmpout
    rlPhaseEnd
