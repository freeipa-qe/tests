...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#   runtest.sh of /CoreOS/ipa-tests/acceptance/ipa-keyctl
#   Description: IPA ipa-keyctl acceptance tests
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
rlJournalStart
    rlPhaseStartSetup "ipa-keyctl startup: Check for ipa-server package"
        rlAssertRpm $PACKAGE
    ...
    rlPhaseStartCleanup "ipa-keyctl cleanup"
        rlRun "popd"
