...
ipa_delegation_cli_cmd_add_negative_envsetup()
{
	rlPhaseStartTest "ipa_delegation_cli_cmd_add_negative_envsetup: Setup add positive test dependencies"
		KinitAsAdmin
	rlPhaseEnd
}
...
ipa_delegation_cli_cmd_add_negative_envcleanup()
{
	rlPhaseStartTest "ipa_delegation_cli_cmd_add_negative_envcleanup: Cleanup add negative test settings"
		KinitAsAdmin
	rlPhaseEnd
}
