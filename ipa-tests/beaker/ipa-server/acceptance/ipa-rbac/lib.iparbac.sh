...
verifyPermissionTypeAttr()
{
    ...
    objectclass=$5
     ...
     rlRun "verifyPermissionAttr $permissionName all \"Permissions\" $permissionAccess" 0 "Verify Permissions"
...
verifyPermissionRawTypeAttr()
{
    ...
    permissionAccessArray=$(echo $permissionAccess | tr "," "\n")
    ...
    objectclassArray=$(echo $objectclass | tr "," "\n")
     ...
     for access in $permissionAccessArray
     do
         rlRun "verifyPermissionAttr $permissionName raw \"permissions\" $access" 0 "Verify Permissions"
     done
...
verifyPermissionSubtree()
{
    ...
    objectclass=$5
     ...
     rlRun "verifyPermissionAttr $permissionName all \"Permission name\" $permissionName" 0 "Verify Permission Name"
     rlRun "verifyPermissionAttr $permissionName all \"Permissions\" $permissionAccess" 0 "Verify Permissions"
     rlRun "verifyPermissionAttr $permissionName all \"Subtree\" $permissionFilter" 0 "Verify Filter"
