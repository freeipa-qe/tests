...
run_selinuxusermap_find_tests(){
    ...
    rlPhaseStartTest "ipa-selinuxusermap-find-014: Find selinuxuser map with --all option"
        rlLog "Executing: ipa selinuxusermap-add --selinuxuser=\"guest_u:s0\" --hbacrule=allow_all --usercat=all --hostcat=all --desc=\"some description\" $selinuxusermap7" 
        rlRun "ipa selinuxusermap-add --selinuxuser=\"guest_u:s0\" --hbacrule=allow_all --usercat=all --hostcat=all --desc=\"some description\" $selinuxusermap7" 0 "Add a selinuxusermap"
	...
	rlAssertGrep "SELinux User: guest_u:s0" "$TmpDir/selinuxusermap-find_test14.out"
    ...
    rlPhaseStartTest "ipa-selinuxusermap-find-016: Find selinuxuser map with --raw option"
        ...
        rlAssertGrep "ipaselinuxuser: guest_u:s0" "$TmpDir/selinuxusermap-find_test16.out"
	...
	rlRun "ipa selinuxusermap-find --raw --all $selinuxusermap7 > $TmpDir/selinuxusermap-find_test16_raw_all.out" 0 "Find selinuxusermap with --all --raw $selinuxusermap7"
        ...
        rlAssertGrep "ipaselinuxuser: guest_u:s0" "$TmpDir/selinuxusermap-find_test16_raw_all.out"
