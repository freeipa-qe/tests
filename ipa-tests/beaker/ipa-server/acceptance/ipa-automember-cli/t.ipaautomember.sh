...
ipaautomember_setAutomemberDefaultGroup_negative_badgroup()
{
	...
	rlPhaseStartTest "ipa-automember-cli-3501: set default hostgroup with non-existent group"
...
ipaautomember_usertest_setup()
{
	...
	rlPhaseStartTest "ipa-automember-usertest-1000: Setup users/groups/rules for user tests"
...
ipaautomember_hosttest_setup()
{
	...
	rlPhaseStartTest "ipa-automember-hosttest-1000: Setup hostgroups/rules for user tests"
