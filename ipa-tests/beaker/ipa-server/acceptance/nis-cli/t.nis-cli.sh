...
{
    # accept parameters: $admin $adminpassword $size_value $day_value
    local admin=$1
...
{
    # accept parameters: $size_value $day_value $expired_value
    local size_value=$1
    local day_value=$2
    local expired_value=$3
    # test logic starts
...
{
    # accept parameters: $admin $adminpassword $size_value $day_value $expired_value $newpw_value
    local admin=$1
    local adminpassword=$2
    local size_value=$3
    local day_value=$4
    local expired_value=$5
    local newpw_value=$6
    # test logic starts
