...
if [ $? -eq 0 ]; then
	...
	testsuites="install         ipa-cert    ipa-default     ipa-functional-services  ipa-hbac-cli     ipa-hostgroup-cli  ipa-password install-client  ipa-config  ipa-delegation  ipa-get-rm-keytab        ipa-hbacsvc-cli  ipa-krbtpolicy     ipa-services      nis-cli install-slave   ipa-ctl     ipa-dns         ipa-group-cli            ipa-host-cli     ipa-netgroup-cli   ipa-set-add-attr  uninstall ipa-user-cli/adduser ipa-user-cli/moduser ipa-i18n"
