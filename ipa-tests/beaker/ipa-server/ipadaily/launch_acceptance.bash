...
testsuites="ipa-user-cli/adduser ipa-user-cli/moduser ipa-group-cli ipa-host-cli ipa-hostgroup-cli ipa-netgroup-cli ipa-set-add-attr nis-cli install ipa-default ipa-password ipa-hbac-cli ipa-hbacsvc-cli ipa-config ipa-dns ipa-get-rm-keytab install-slave install-client uninstall"
