...
#
######### Include directories ############################################
. $mainRunBaseDir/acceptance/quickinstall/engage.quickinstall.sh
. $mainRunBaseDir/acceptance/memberof/engage.memberof.sh
. $mainRunBaseDir/acceptance/multimaster/engage.multimaster.sh
. $mainRunBaseDir/acceptance/quickuninstall/engage.quickuninstall.sh
. $mainRunBaseDir/acceptance/cli/engage.cli.sh
. $mainRunBaseDir/acceptance/client/engage.client.sh
. $mainRunBaseDir/acceptance/pwpolicy/engage.pwpolicy.sh
. $mainRunBaseDir/acceptance/sssd/engage.sssd.sh
. $mainRunBaseDir/sample/engage.sample.sh
