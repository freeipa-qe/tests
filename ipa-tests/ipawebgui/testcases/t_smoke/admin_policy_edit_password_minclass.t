...
our $testfullgid;
our $testdata;
our @datakeys=("form_krbpwdmindiffchars");
...
sub run_test {
   # test case name (admin_policy_edit_password_minclass) from source (admin_policy_edit_password_minclass.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->type_ok("form_krbpwdmindiffchars", "$testdata->{'form_krbpwdmindiffchars'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Min. Number of Character Classes: $testdata->{'form_krbpwdmindiffchars'}");
