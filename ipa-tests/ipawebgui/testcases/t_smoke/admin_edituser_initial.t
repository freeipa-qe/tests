...
sub run_test {
   # test case name (admin_edituser_initial) from source (admin_edituser_initial.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Initials: $testdata->{'form_initials'}");
