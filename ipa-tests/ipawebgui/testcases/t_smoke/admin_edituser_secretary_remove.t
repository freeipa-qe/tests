...
sub run_test {
   # test case name (admin_edituser_secretary_remove) from source (admin_edituser_secretary_remove.pl)
   # auto generated at 2008/5/16:10:54:41
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Secretary: 	\nAdministrator");
	$sel->click_ok("//a[\@onclick=\"return clearSelect('secretary');\"]");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("a001edit updated!");
} #admin_edituser_secretary_remove
