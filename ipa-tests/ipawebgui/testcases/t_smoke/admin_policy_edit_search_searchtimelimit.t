...
our $testfullgid;
our $testdata;
our @datakeys=("form_ipasearchtimelimit");
...
sub run_test {
   # test case name (admin_policy_edit_search_searchtimelimit) from source (admin_policy_edit_search_searchtimelimit.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->type_ok("form_ipasearchtimelimit", "$testdata->{'form_ipasearchtimelimit'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("IPA Policy updated");
	$sel->is_text_present_ok("Search Time Limit (sec.): $testdata->{'form_ipasearchtimelimit'}");
