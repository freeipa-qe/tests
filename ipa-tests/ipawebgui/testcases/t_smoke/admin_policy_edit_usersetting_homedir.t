...
our $testfullgid;
our $testdata;
our @datakeys=("form_ipahomesrootdir");
...
sub run_test {
   # test case name (admin_policy_edit_usersetting_homedir) from source (admin_policy_edit_usersetting_homedir.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->type_ok("form_ipahomesrootdir", "$testdata->{'form_ipahomesrootdir'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Root for Home Directories: $testdata->{'form_ipahomesrootdir'}");
