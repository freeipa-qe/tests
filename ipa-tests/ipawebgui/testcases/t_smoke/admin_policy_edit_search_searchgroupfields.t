...
our $testfullgid;
our $testdata;
our @datakeys=("form_ipagroupsearchfields");
...
sub run_test {
   # test case name (admin_policy_edit_search_searchgroupfields) from source (admin_policy_edit_search_searchgroupfields.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->type_ok("form_ipagroupsearchfields", "$testdata->{'form_ipagroupsearchfields'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Group Search Fields: $testdata->{'form_ipagroupsearchfields'}");
