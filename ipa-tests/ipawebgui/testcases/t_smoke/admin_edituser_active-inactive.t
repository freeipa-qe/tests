...
sub run_test {
   # test case name (admin_edituser_active-inactive) from source (admin_edituser_active-inactive.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Account Status: inactive");
} #admin_edituser_active-inactive
