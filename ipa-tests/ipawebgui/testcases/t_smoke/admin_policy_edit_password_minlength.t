...
our $testfullgid;
our $testdata;
our @datakeys=("form_krbpwdminlength");
...
sub run_test {
   # test case name (admin_policy_edit_password_minlength) from source (admin_policy_edit_password_minlength.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->type_ok("form_krbpwdminlength", "$testdata->{'form_krbpwdminlength'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Min. Length of Password: $testdata->{'form_krbpwdminlength'}");
