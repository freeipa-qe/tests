...
our $testfullgid;
our $testdata;
our @datakeys=("form_ipadefaultemaildomain");
...
sub run_test {
   # test case name (admin_policy_edit_usersetting_defaultemaildomain) from source (admin_policy_edit_usersetting_defaultemaildomain.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->type_ok("form_ipadefaultemaildomain", "$testdata->{'form_ipadefaultemaildomain'}");
	$sel->click_ok("document.form.submit[2]");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("IPA Policy updated");
	$sel->is_text_present_ok("Default E-mail Domain: $testdata->{'form_ipadefaultemaildomain'}");
