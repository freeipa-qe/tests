...
our $testfullgid;
our $testdata;
our @datakeys=("form_ipasearchrecordslimit");
...
sub run_test {
   # test case name (admin_policy_edit_search_searchrecordlimit) from source (admin_policy_edit_search_searchrecordlimit.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->type_ok("form_ipasearchrecordslimit", "$testdata->{'form_ipasearchrecordslimit'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Search Records Limit: $testdata->{'form_ipasearchrecordslimit'}");
