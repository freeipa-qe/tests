...
sub run_test {
   # test case name (admin_edit_group_inactive-active) from source (admin_edit_group_inactive-active.pl)
   # auto generated at 2008/5/16:10:54:41
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->select_ok("form_nsAccountLock", "label=active");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("autogrp001-edit updated!");
	$sel->is_text_present_ok("Group Status: 	active");
} #admin_edit_group_inactive-active
