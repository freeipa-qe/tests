...
our $testfullgid;
our $testdata;
our @datakeys=("form_krbmaxpwdlife");
...
sub run_test {
   # test case name (admin_policy_edit_password_maxlifetime) from source (admin_policy_edit_password_maxlifetime.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->type_ok("form_krbmaxpwdlife", "$testdata->{'form_krbmaxpwdlife'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("IPA Policy updated");
	$sel->is_text_present_ok("Max. Password Lifetime (days): $testdata->{'form_krbmaxpwdlife'}");
