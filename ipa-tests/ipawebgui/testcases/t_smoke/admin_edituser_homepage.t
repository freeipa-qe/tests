...
sub run_test {
   # test case name (admin_edituser_homepage) from source (admin_edituser_homepage.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Home Page: $testdata->{'form_labeleduri'}");
