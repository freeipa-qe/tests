...
sub run_test {
   # test case name (admin_policy_edit_usersetting_shell) from source (admin_policy_edit_usersetting_shell.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Default Shell: $testdata->{'form_ipadefaultloginshell'}");
