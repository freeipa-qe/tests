...
sub run_test {
   # test case name (admin_policy_edit_search_searchuserfields) from source (admin_policy_edit_search_searchuserfields.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("User Search Fields: $testdata->{'form_ipausersearchfields'}");
