...
our $testfullgid;
our $testdata;
our @datakeys=("form_telephonenumbers_0_telephonenumber");
...
sub run_test {
   # test case name (admin_edituser_worknumber) from source (admin_edituser_worknumber.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Work Number: $testdata->{'form_telephonenumbers_0_telephonenumber'}");
