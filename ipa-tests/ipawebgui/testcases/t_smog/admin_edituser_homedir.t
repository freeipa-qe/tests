...
our $testfullgid;
our $testdata;
our @datakeys=("form_homedirectory");
...
sub run_test {
   # test case name (admin_edituser_homedir) from source (admin_edituser_homedir.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->type_ok("form_homedirectory", "$testdata->{'form_homedirectory'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("$testuid updated!");
	$sel->is_text_present_ok("Home Directory: $testdata->{'form_homedirectory'}");
