...
sub run_test {
   # test case name (admin_principal_add_dns) from source (admin_principal_add_dns.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->select_ok("form_service", "label=dns");
	$sel->type_ok("form_hostname", "dns.test.com");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->value_is("hostname", "dns.test.com");
	$sel->is_text_present_ok("dns/dns.test.com added!");
