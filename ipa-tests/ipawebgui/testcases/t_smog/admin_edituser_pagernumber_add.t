...
our $testfullgid;
our $testdata;
our @datakeys=("form_pagers_1_pager");
...
sub run_test {
   # test case name (admin_edituser_pagernumber_add) from source (admin_edituser_pagernumber_add.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->click_ok("form_pagers_doclink");
	$sel->type_ok("form_pagers_1_pager", "$testdata->{'form_pagers_1_pager'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("$testuid updated!");
	#$sel->is_text_present_ok("$testdata->{'form_pagers_1_pager'}"); #FIXME: It is always a problem to add number
