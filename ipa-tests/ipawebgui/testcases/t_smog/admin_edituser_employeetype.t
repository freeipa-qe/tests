...
our $testfullgid;
our $testdata;
our @datakeys=("form_employeetype");
...
sub run_test {
   # test case name (admin_edituser_employeetype) from source (admin_edituser_employeetype.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Employee Type: $testdata->{'form_employeetype'}");
