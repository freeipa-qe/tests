...
our $testfullgid;
our $testdata;
our @datakeys=("form_homephones_0_homephone");
...
sub run_test {
   # test case name (admin_edituser_homephone) from source (admin_edituser_homephone.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Home Number: $testdata->{'form_homephones_0_homephone'}");
