...
sub run_test {
   # test case name (admin_edituser_fullname) from source (admin_edituser_fullname.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Full Name: $testdata->{'form_cns_0_cn'}");
