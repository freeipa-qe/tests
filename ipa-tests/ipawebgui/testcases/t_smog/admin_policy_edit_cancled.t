...
sub run_test {
   # test case name (admin_policy_edit_cancled) from source (admin_policy_edit_cancled.pl)
   # auto generated at 2008/5/16:10:54:41
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("Edit policy cancelled");
	$sel->is_text_present_ok("Search Time Limit (sec.): 	1");
