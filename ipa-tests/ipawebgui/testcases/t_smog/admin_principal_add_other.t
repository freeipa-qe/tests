...
our $testfullgid;
our $testdata;
our @datakeys=("form_hostname","form_other");
...
sub run_test {
   # test case name (admin_principal_add_other) from source (admin_principal_add_other.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->select_ok("form_service", "label=other");
	$sel->type_ok("form_hostname", "other.test.com");
	$sel->type_ok("form_other", "other services");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->value_is("hostname", "other.test.com");
	$sel->is_text_present_ok("other services/other.test.com added!");
