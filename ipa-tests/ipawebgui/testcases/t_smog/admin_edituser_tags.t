...
our $testfullgid;
our $testdata;
our @datakeys=("form_businesscategory");
...
sub run_test {
   # test case name (admin_edituser_tags) from source (admin_edituser_tags.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Tags: $testdata->{'form_businesscategory'}");
} #admin_edituser_tags
