...
our $testfullgid;
our $testdata;
our @datakeys=("form_homephones_1_homephone");
...
sub run_test {
   # test case name (admin_edituser_homnumber_add) from source (admin_edituser_homnumber_add.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->click_ok("form_homephones_doclink");
	$sel->type_ok("form_homephones_1_homephone", "$testdata->{'form_homephones_1_homephone'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("$testuid updated!");
	#$sel->is_text_present_ok("$testdata->{'form_homephones_1_homephone'}"); #FIXME
