...
our $testfullgid;
our $testdata;
our @datakeys=("form_mobiles_1_mobile");
...
sub run_test {
   # test case name (admin_edituser_cellphone_add) from source (admin_edituser_cellphone_add.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->type_ok("form_mobiles_1_mobile", "$testdata->{'form_mobiles_1_mobile'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("$testuid updated!");
	#$sel->is_text_present_ok("$testdata->{'form_mobiles_1_mobile'}"); #FIXME
