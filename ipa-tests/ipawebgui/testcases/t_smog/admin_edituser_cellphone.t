...
our $testfullgid;
our $testdata;
our @datakeys=("form_mobiles_0_mobile");
...
sub run_test {
   # test case name (admin_edituser_cellphone) from source (admin_edituser_cellphone.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Cell Number: $testdata->{'form_mobiles_0_mobile'}");
