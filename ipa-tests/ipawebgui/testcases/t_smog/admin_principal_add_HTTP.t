...
sub run_test {
   # test case name (admin_principal_add_HTTP) from source (admin_principal_add_HTTP.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->select_ok("form_service", "label=HTTP");
	$sel->type_ok("form_hostname", "HTTP.test.com");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->value_is("hostname", "HTTP.test.com");
	$sel->is_text_present_ok("HTTP/HTTP.test.com added!");
