...
sub run_test {
   # test case name (admin_edit_group_removeusermember) from source (admin_edit_group_removeusermember.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->open_ok("/ipa/ui/group/show?cn=$testgid");
	...
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("$testgid updated!");
} #admin_edit_group_removeusermember
...
sub prepare_data{
        ...
        IPAutil::ipa_adduser2group($ssh, $testuid, $testgid);
}
