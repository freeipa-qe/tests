...
sub run_test {
   # test case name (admin_edituser_carlicense) from source (admin_edituser_carlicense.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Car License: $testdata->{'form_carlicense'}");
