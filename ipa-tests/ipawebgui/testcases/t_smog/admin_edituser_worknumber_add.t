...
our $testfullgid;
our $testdata;
our @datakeys=("form_telephonenumbers_1_telephonenumber");
...
sub run_test {
   # test case name (admin_edituser_worknumber_add) from source (admin_edituser_worknumber_add.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->type_ok("form_telephonenumbers_1_telephonenumber", "$testdata->{'form_telephonenumbers_1_telephonenumber'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("$testuid updated!");
	#$sel->is_text_present_ok("$testdata->{'form_telephonenumbers_1_telephonenumber'}"); #FIXME: I need this line to work
