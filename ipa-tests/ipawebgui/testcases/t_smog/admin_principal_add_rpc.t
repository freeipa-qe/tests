...
sub run_test {
   # test case name (admin_principal_add_rpc) from source (admin_principal_add_rpc.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->select_ok("form_service", "label=rpc");
	$sel->type_ok("form_hostname", "rpc.test.com"); # FIXME: hard code data used here
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->value_is("hostname", "rpc.test.com");
	$sel->is_text_present_ok("rpc/rpc.test.com added!");
