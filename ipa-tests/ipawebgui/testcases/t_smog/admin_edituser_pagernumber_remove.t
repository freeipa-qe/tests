...
sub run_test {
   # test case name (admin_edituser_pagernumber_remove) from source (admin_edituser_pagernumber_remove.pl)
   # auto generated at 2008/5/16:10:54:41
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->click_ok("//a[contains(\@href, \"javascript:ExpandingForm.removeItem('form_pagers_1')\")]");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("a001edit updated!");
	$sel->is_text_present_ok("Pager Number: 	\n400-200-1003");
} #admin_edituser_pagernumber_remove
