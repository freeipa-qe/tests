...
sub run_test {
   # test case name (admin_edituser_streetaddress) from source (admin_edituser_streetaddress.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	#$sel->is_text_present_ok("Street Address:  $testdata->{'form_street'}"); # FIXME: does next line sufficient?
	$sel->is_text_present_ok("$testdata->{'form_street'}");
