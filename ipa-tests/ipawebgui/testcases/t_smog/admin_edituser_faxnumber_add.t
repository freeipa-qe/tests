...
our $testfullgid;
our $testdata;
our @datakeys=("form_facsimiletelephonenumbers_1_facsimiletelephonenumber");
...
sub run_test {
   # test case name (admin_edituser_faxnumber_add) from source (admin_edituser_faxnumber_add.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->wait_for_page_to_load_ok("30000");
	$sel->click_ok("form_facsimiletelephonenumbers_doclink");
	$sel->type_ok("form_facsimiletelephonenumbers_1_facsimiletelephonenumber", "$testdata->{'form_facsimiletelephonenumbers_1_facsimiletelephonenumber'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("$testuid updated!");
	#$sel->is_text_present_ok("$testdata->{'form_facsimiletelephonenumbers_1_facsimiletelephonenumber'}");#FIXME
