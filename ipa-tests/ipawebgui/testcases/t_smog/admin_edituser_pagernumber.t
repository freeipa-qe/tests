...
our $testfullgid;
our $testdata;
our @datakeys=("form_pagers_0_pager");
...
sub run_test {
   # test case name (admin_edituser_pagernumber) from source (admin_edituser_pagernumber.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Pager Number: $testdata->{'form_pagers_0_pager'}");
