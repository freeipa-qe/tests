...
sub run_test {
   # test case name (admin_edituser_uid) from source (admin_edituser_uid.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->type_ok("form_uidnumber", "$testdata->{'form_uidnumber'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
	$sel->is_text_present_ok("$testuid updated!");
	$sel->is_text_present_ok("UID: $testdata->{'form_uidnumber'}");
} #admin_edituser_uid
