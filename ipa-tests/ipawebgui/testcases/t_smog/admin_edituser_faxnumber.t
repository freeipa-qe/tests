...
our $testfullgid;
our $testdata;
our @datakeys=("form_facsimiletelephonenumbers_0_facsimiletelephonenumber");
...
sub run_test {
   # test case name (admin_edituser_faxnumber) from source (admin_edituser_faxnumber.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->is_text_present_ok("Fax Number: $testdata->{'form_facsimiletelephonenumbers_0_facsimiletelephonenumber'}");
