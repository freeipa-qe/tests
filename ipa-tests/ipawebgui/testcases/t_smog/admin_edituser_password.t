...
our $testfullgid;
our $testdata;
our @datakeys=("form_krbprincipalkey","form_krbprincipalkey_confirm");
...
sub run_test {
   # test case name (admin_edituser_password) from source (admin_edituser_password.pl)
   # auto generated at 2008/5/26:10:37:52
	...
	$sel->type_ok("form_krbprincipalkey_confirm", "$testdata->{'form_krbprincipalkey'}");
	$sel->click_ok("submit");
	$sel->wait_for_page_to_load_ok("30000");
