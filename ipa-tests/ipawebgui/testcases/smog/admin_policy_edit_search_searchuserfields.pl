...
$sel->wait_for_page_to_load_ok("30000");
$sel->type_ok("form_ipausersearchfields", "uid,givenName,sn,telephoneNumber,ou,title,");
$sel->type_ok("form_ipausersearchfields", "uid,givenName,sn,telephoneNumber,ou,title,street");
$sel->click_ok("submit");
$sel->wait_for_page_to_load_ok("30000");
